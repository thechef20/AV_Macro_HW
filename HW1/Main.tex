...
\begin{enumerate}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width =.5\linewidth]{pics/HW1/HW1_Q2_a.png}
        \caption{Capital per Worker}
    \end{figure}
    \vspace{-.5cm}
    \begin{figure}[h]
        \centering
        \includegraphics[width =.5\linewidth]{pics/HW1/HW1_Q2_b.png}
        \caption{Output per Worker}
    \end{figure}
    \begin{figure}[h]
        \centering
        \includegraphics[width =.5\linewidth]{pics/HW1/HW1_Q2_c.png}
