...
\begin{enumerate}
    ...
    $(1-.1)\Bar{k}+\frac{1}{1+.25\Bar{k}^{-0.75}}*.5*\Bar{k}^{.25}=\Bar{k}(1+.02)$\\
    $0.9*\Bar{k}+\frac{1}{1+.25\Bar{k}^{-0.75}}*.5*\Bar{k}^{.25}=\Bar{k}*1.02$\\
    $\frac{1}{1+.25\Bar{k}^{-0.75}}*\Bar{k}^{.25}=\Bar{k}*0.24$\\
    $\frac{1}{1+.25\Bar{k}^{-0.75}}=\Bar{k}^{.75}*0.24$\\
    $1=(\Bar{k}^{.75}*0.24)*(1+.25\Bar{k}^{-0.75})$\\
    $1=0.24\Bar{k}^{0.75}+0.06$\\
